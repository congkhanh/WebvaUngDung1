...
namespace MVCKLShop.ServiceReferenceDatHang {
    ...
    public interface IServiceDatHang {
        ...
        MVCKLShop.ServiceReferenceDatHang.DonHang[] All();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/All", ReplyAction="http://tempuri.org/IServiceDatHang/AllResponse")]
        System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang[]> AllAsync();
        ...
        MVCKLShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/DonHangTheoUser", ReplyAction="http://tempuri.org/IServiceDatHang/DonHangTheoUserResponse")]
        System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser);
        ...
        MVCKLShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/LayMaHD", ReplyAction="http://tempuri.org/IServiceDatHang/LayMaHDResponse")]
        System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceDatHangChannel : MVCKLShop.ServiceReferenceDatHang.IServiceDatHang, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceDatHangClient : System.ServiceModel.ClientBase<MVCKLShop.ServiceReferenceDatHang.IServiceDatHang>, MVCKLShop.ServiceReferenceDatHang.IServiceDatHang {
        ...
        public MVCKLShop.ServiceReferenceDatHang.DonHang[] All() {
            return base.Channel.All();
        }
        
        public System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang[]> AllAsync() {
            return base.Channel.AllAsync();
        }
        
        public MVCKLShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser) {
            return base.Channel.DonHangTheoUser(iduser);
        }
        
        public System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser) {
            return base.Channel.DonHangTheoUserAsync(iduser);
        }
        
        public MVCKLShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser) {
            return base.Channel.LayMaHD(iduser);
        }
        
        public System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser) {
