...
namespace MVCKLShop.ServiceReferenceUser {
    ...
    public interface IServiceUser {
        ...
        MVCKLShop.ServiceReferenceUser.User[] All();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/All", ReplyAction="http://tempuri.org/IServiceUser/AllResponse")]
        System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceUser.User[]> AllAsync();
        ...
        bool AddUser(string IDUser, string PassUser, string HoTenUser, string Email, string DiaChi, string SoDienThoai, string NgaySinh);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(string IDUser, string PassUser, string HoTenUser, string Email, string DiaChi, string SoDienThoai, string NgaySinh);
        ...
        MVCKLShop.ServiceReferenceUser.User TimEDitUser(string IDUser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/TimEDitUser", ReplyAction="http://tempuri.org/IServiceUser/TimEDitUserResponse")]
        System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceUser.User> TimEDitUserAsync(string IDUser);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : MVCKLShop.ServiceReferenceUser.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<MVCKLShop.ServiceReferenceUser.IServiceUser>, MVCKLShop.ServiceReferenceUser.IServiceUser {
        ...
        public MVCKLShop.ServiceReferenceUser.User[] All() {
            return base.Channel.All();
        }
        
        public System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceUser.User[]> AllAsync() {
        ...
        public bool AddUser(string IDUser, string PassUser, string HoTenUser, string Email, string DiaChi, string SoDienThoai, string NgaySinh) {
            return base.Channel.AddUser(IDUser, PassUser, HoTenUser, Email, DiaChi, SoDienThoai, NgaySinh);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(string IDUser, string PassUser, string HoTenUser, string Email, string DiaChi, string SoDienThoai, string NgaySinh) {
            return base.Channel.AddUserAsync(IDUser, PassUser, HoTenUser, Email, DiaChi, SoDienThoai, NgaySinh);
        }
        
        public MVCKLShop.ServiceReferenceUser.User TimEDitUser(string IDUser) {
            return base.Channel.TimEDitUser(IDUser);
        }
        
        public System.Threading.Tasks.Task<MVCKLShop.ServiceReferenceUser.User> TimEDitUserAsync(string IDUser) {
