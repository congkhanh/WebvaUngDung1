...
namespace WcfServiceKLShop
{
    ...
    public class ServiceSanPham : IServiceSanPham
    {
        ...
        public bool ThemSanPham(int masp, string tensp, string madm, decimal gia, string mota, string kichthuoc, string mausac, string hinhanh, string soluong, int trangthai)
        {
