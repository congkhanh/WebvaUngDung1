...
namespace WFORMKLShop.ServiceReferenceDatHang {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="DonHang", Namespace="http://schemas.datacontract.org/2004/07/WcfServiceKLShop")]
    ...
    public interface IServiceDatHang {
        ...
        WFORMKLShop.ServiceReferenceDatHang.DonHang[] All();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/All", ReplyAction="http://tempuri.org/IServiceDatHang/AllResponse")]
        System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> AllAsync();
        ...
        WFORMKLShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/DonHangTheoUser", ReplyAction="http://tempuri.org/IServiceDatHang/DonHangTheoUserResponse")]
        System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser);
        ...
        WFORMKLShop.ServiceReferenceDatHang.DonHang[] TimTheoNgay(System.DateTime ngay);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/TimTheoNgay", ReplyAction="http://tempuri.org/IServiceDatHang/TimTheoNgayResponse")]
        System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> TimTheoNgayAsync(System.DateTime ngay);
        ...
        WFORMKLShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/LayMaHD", ReplyAction="http://tempuri.org/IServiceDatHang/LayMaHDResponse")]
        System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceDatHangChannel : WFORMKLShop.ServiceReferenceDatHang.IServiceDatHang, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceDatHangClient : System.ServiceModel.ClientBase<WFORMKLShop.ServiceReferenceDatHang.IServiceDatHang>, WFORMKLShop.ServiceReferenceDatHang.IServiceDatHang {
        ...
        public WFORMKLShop.ServiceReferenceDatHang.DonHang[] All() {
            return base.Channel.All();
        }
        
        public System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> AllAsync() {
            return base.Channel.AllAsync();
        }
        
        public WFORMKLShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser) {
            return base.Channel.DonHangTheoUser(iduser);
        }
        
        public System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser) {
            return base.Channel.DonHangTheoUserAsync(iduser);
        }
        
        public WFORMKLShop.ServiceReferenceDatHang.DonHang[] TimTheoNgay(System.DateTime ngay) {
            return base.Channel.TimTheoNgay(ngay);
        }
        
        public System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang[]> TimTheoNgayAsync(System.DateTime ngay) {
            return base.Channel.TimTheoNgayAsync(ngay);
        }
        
        public WFORMKLShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser) {
            return base.Channel.LayMaHD(iduser);
        }
        
        public System.Threading.Tasks.Task<WFORMKLShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser) {
