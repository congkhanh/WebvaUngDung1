...
using WFORMKLShop.ServiceReferenceNhapHang;
...
using WFORMKLShop.ServiceReferenceDatHang;
using WFORMKLShop.ServiceReferenceCTPhieuNhapCustom;
...
namespace WFORMKLShop
{
    public partial class FormCTNhapHang : Form
    {
        ...
        {
            int idSP = Int32.Parse( cboTenSP.SelectedValue.ToString().Trim());
